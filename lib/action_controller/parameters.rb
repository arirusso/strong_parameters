...
module ActionController
  ...
  class Parameters < HashWithIndifferentAccess
    ...
    # If the requested method exists in the strong parameters instance module,
    # include the module
    ...
    # If the require method is called, include the strong parameters module.
    # This is necessary because the name require conflicts with Object(Kernel)#require
    def require(*args)
      self.class.send(:include, StrongParameters)
      super
    end
  ...
  # Strong parameter instance methods
  module StrongParameters

    # Add the stuff normally done via class methods 
